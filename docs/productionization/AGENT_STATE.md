...
- `roadmap_status`: `pit_06_in_progress`
...
| PIT-06 | `4782754746e02efb28b3078707d7c266728b0970` | `codex/pit-06-evidence-bundle` | #23 | RED `4c3c40a85d9a44b485301839b35091d93537d240`; implementation/final pending | `high`; `high_implementer` Sol/high; reviewer planned `reviewer_high` Sol/high; master Sol/xhigh | RED PASS — test/fixture-only expected missing module | PENDING | PENDING — PR #23 JIT | none | IN PROGRESS |
