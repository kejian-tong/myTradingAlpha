...
- `roadmap_status`: `pit_04_in_progress`
...
| PIT-04 | `f7d96ccfc311d4e48cf32748b4645343272eeb21` | `codex/pit-04-events-social-macro` | #21 | RED `3d2a8dd8dfb1001f22ff627267b88170913f8460`; implementation/final head pending | `high`; `high_implementer` / `.codex/agents/high-implementer.toml` / configured actual GPT-5.6 Sol / high; reviewer planned `reviewer_high` / `.codex/agents/reviewer-high.toml` / configured GPT-5.6 Sol / high; master GPT-5.6 Sol / xhigh | RED PASS — test/fixture-only commit; expected missing-module failure; GREEN pending | PENDING | PENDING — JIT spec PR #21 body | none observed | IN PROGRESS / next: PIT-04 merge gate |
...
- Autonomous orchestration remains active by explicit user instruction. PIT-01 is merged with no
  ...
  Master merge artifact remain required; PIT-04 is now active on PR #21 after PIT-03 merged. GREEN and
  all exact-head gates remain pending.
