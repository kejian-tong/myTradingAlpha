...
| FND-04 | `06075e4a8aba7ee21cb5d911bd41b4360e00a9dc` | `codex/fnd-04-lock-ci-doc-gates` | #14 | RED `e37aaff3e946dd7eb9337a0ba74a88d6448dfe46`; merge pending | `normal`; implementer `normal_implementer` / `.codex/agents/normal-implementer.toml` / configured actual GPT-5.6 Luna / max; reviewer `reviewer_high` / `.codex/agents/reviewer-high.toml` / configured GPT-5.6 Sol / high; master GPT-5.6 Sol / xhigh | RED PASS — focused command exit 1 with 17 expected failures, 2 passes; Ruff/diff pass; GREEN pending | PENDING | PENDING | none observed | IN PROGRESS / next after merge: PIT-01 |
...
- FND-04 is active as draft PR #14. Its RED history is durable; GREEN remains blocked until the JIT
  spec is persisted in the PR body. Validation, exact-head CI/review, and master gate then remain.
