...
- `active_writer`: `normal_implementer (stopping; Master release required before review)` /
...
GREEN is implemented in the dedicated writer lane; final head, independent review, required CI, and
merge are pending. No SIG-04 or later roadmap implementation, portfolio/risk/order/broker/PAPER/live
