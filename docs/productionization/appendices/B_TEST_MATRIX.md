...
| Research adapter | `research/test_adapter.py` | Read-only EvidenceBundle input; pending outcome/current network path denied in historical mode | `pytest -q tests/productionization/research` |
