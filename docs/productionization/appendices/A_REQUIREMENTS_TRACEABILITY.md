...
| R-05 | Historical mode is immutable EvidenceBundle and network-free | [02 Target Architecture](../02_TARGET_ARCHITECTURE.md), [Phase 01 Design](../phases/01-point-in-time-data/DESIGN.md) | PIT-06, SIG-01 | `test_bundle_replay.py`, adapter socket-denial fixture |
